...
# SCPN Magnetic Cusp Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-MAGNETIC-CUSP-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_magnetic_cusp_core.observability.CATALOGUE_BINDING`.
    plan_identifier
